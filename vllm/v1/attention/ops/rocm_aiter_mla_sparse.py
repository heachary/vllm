...
def rocm_sparse_attn_decode(
    ...
    enable_sparse_mla_opt_v3 = os.getenv("VLLM_ENABLE_SPARSE_MLA_OPT_V3", "0")
    if enable_sparse_mla_opt_v3 == "1":
        from vllm.v1.attention.ops.sparse_mla_opt.rocm_aiter_mla_sparse_v3 import (
        rocm_sparse_attn_decode_v3,
    )
        return rocm_sparse_attn_decode_v3(
            q=q,
            kv_cache=kv_cache,
            swa_k_cache=swa_k_cache,
            swa_only=swa_only,
